...
def test_nightly_compute_stays_below_3850_hours(nightly_test_suite, tracker):
    ...
    assert total_gpu_hours <= 3850, (
        f"Total GPU hours exceeded 3850: {last_line}. We should revisit the test suites to reduce the total GPU hours."
    )
